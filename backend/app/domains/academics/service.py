...
class AcademicEligibilityService:
    ...
    async def subject_applies_to_class(
        ...
        *,
        ...
        Before specialization starts, every active CurriculumSubject applies to
        every active class in its curriculum level. Once specialization starts,
        the class must have an exact ClassTermDepartment projection. Subjects
        without department links are general; department-scoped subjects apply
        only when the class department matches one of their links.
        """
