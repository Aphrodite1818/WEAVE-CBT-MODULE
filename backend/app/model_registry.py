...
Alembic imports this module before reading Base.metadata. Keep new durable model
modules listed here so autogenerate and `alembic check` see the complete local
CBT schema.
"""
